...
public class Stage1Manager : MonoBehaviour
{
    ...
    private Stage1HealthManager healthManager;
    ...
    void Start()
    {
        ...
        AudioManager.Instance.SetGameModeAndStage(AudioManager.GameMode.BossRush, 0); // Stage 1

        // Find the stage-specific health manager in this scene
        healthManager = FindObjectOfType<Stage1HealthManager>();
    ...
    void DisplayQuestion()
    {
        ...
        for (int i = 0; i < answerButtons.Length; i++)
        {
            ...
            answerButtons[i].GetComponent<UnityEngine.UI.Image>().color = normalColor;
    ...
    public void OnAnswerSelected(int answerIndex)
    {
        ...
        foreach (UnityEngine.UI.Button button in answerButtons)
        {
        ...
        for (int i = 0; i < answerButtons.Length; i++)
        {
            ...
            {
                answerButtons[i].GetComponent<UnityEngine.UI.Image>().color = correctColor;
            }
            else if (i == answerIndex && !isCorrect)
            {
                answerButtons[i].GetComponent<UnityEngine.UI.Image>().color = wrongColor;
            }
        }
    ...
    IEnumerator PlayAnswerAnimations(bool isCorrect)
    {
        ...
        else
        {
            ...
            answerButtons[shuffledQuestions[currentQuestionIndex].correctAnswer]
                .GetComponent<UnityEngine.UI.Image>().color = correctColor;
    ...
    public void GoToNextStage()
    {
        ...
        AudioManager.Instance.SetGameModeAndStage(AudioManager.GameMode.BossRush, 1); // to Stage 2
