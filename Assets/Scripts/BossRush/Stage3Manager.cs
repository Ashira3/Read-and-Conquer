...
public class Stage3Manager : MonoBehaviour
{
    ...
    private Stage3HealthManager healthManager;
    ...
    void Start()
    {
        ...
        AudioManager.Instance.SetGameModeAndStage(AudioManager.GameMode.BossRush, 2); // Stage 2

        // Find the stage-specific health manager in this scene
        healthManager = FindObjectOfType<Stage3HealthManager>();
    ...
    public void GoToNextStage()
    {
        ...
        AudioManager.Instance.SetGameModeAndStage(AudioManager.GameMode.BossRush, 2); // to Stage 4
    ...
    public void StartNewBossRushGame()
    {
        ...
        var healthManager = FindObjectOfType<Stage3HealthManager>();
        if (healthManager != null)
        {
