...
public class Stage4Manager : MonoBehaviour
{
    ...
    private Stage4HealthManager healthManager;
    ...
    void Start()
    {
        ...
        AudioManager.Instance.SetGameModeAndStage(AudioManager.GameMode.BossRush, 3); // Stage 4

        // Find the stage-specific health manager in this scene
        healthManager = FindObjectOfType<Stage4HealthManager>();
    ...
    public void GoToNextStage()
    {
        ...
        AudioManager.Instance.SetGameModeAndStage(AudioManager.GameMode.BossRush, 4); // to Stage 5
    ...
    public void StartNewBossRushGame()
    {
        ...
        var healthManager = FindObjectOfType<Stage4HealthManager>();
        if (healthManager != null)
        {
