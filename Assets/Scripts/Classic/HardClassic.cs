...
public class HardClassicModeManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        AudioManager.Instance.SetGameModeAndStage(AudioManager.GameMode.Classic, 2); // Easy Diff
    ...
    public void ProceedToMediumDifficulty()
    {
        ...
        AudioManager.Instance.SetGameModeAndStage(AudioManager.GameMode.TitleScreen, 0); // to Mid Diff
