...
public class MediumClassicModeManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        AudioManager.Instance.SetGameModeAndStage(AudioManager.GameMode.Classic, 1); // Mid Diff
    ...
    public void ProceedToMediumDifficulty()
    {
        ...
        AudioManager.Instance.SetGameModeAndStage(AudioManager.GameMode.Classic, 2); // to Hard Diff
