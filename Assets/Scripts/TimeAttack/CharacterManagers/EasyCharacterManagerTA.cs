...
public class EasyCharacterManagerTA : MonoBehaviour
{
    [System.Serializable]
    ...
    private EasyCharacterAnimator currentAnimator;
    ...
    private void Start()
    {
        ...
        if (quizManager != null)
        {
            ...
            quizManager.OnTimeUp += HandleTimeUp; // Add this line
    ...
    private IEnumerator TransitionToNextCharacter()
    {
        ...
        if (currentCharacterIndex < characterInstances.Count)
        {
            ...
            currentAnimator = nextChar.GetComponent<EasyCharacterAnimator>();
