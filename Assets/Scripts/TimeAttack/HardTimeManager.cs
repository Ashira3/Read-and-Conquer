...
public class HardTimeAttackManager : MonoBehaviour
{
    ...
    private HardCharacterManagerTA characterManager;

    private void Start()
    {
        // Set the current game mode and stage
        AudioManager.Instance.SetGameModeAndStage(AudioManager.GameMode.TimeAttack, 2); // Mid Diff

        // Get reference to the character manager
        characterManager = FindFirstObjectByType<HardCharacterManagerTA>();
