...
public class TAHardResultsManager : MonoBehaviour
{
    ...
    [SerializeField] private string currentMode = "TimeAttack";
    [SerializeField] private string currentDifficulty = "Hard";
