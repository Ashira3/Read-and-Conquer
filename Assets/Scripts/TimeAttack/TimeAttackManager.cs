...
public class TimeAttackManager : MonoBehaviour
{
    ...
    private EasyCharacterManagerTA characterManager;

    private void Start()
    {
        // Set the current game mode and stage
        AudioManager.Instance.SetGameModeAndStage(AudioManager.GameMode.TimeAttack, 0); // Easy Diff

        // Get reference to the character manager
        characterManager = FindFirstObjectByType<EasyCharacterManagerTA>();
    ...
    private void DisplayCurrentQuestion()
    {
        ...
        // Just handle the very first question when the game starts
        ...
        // For all other questions, ProceedToNextQuestion handles it
    }
    ...
    public void ProceedToMediumDifficulty()
    {
        ...
        AudioManager.Instance.SetGameModeAndStage(AudioManager.GameMode.TimeAttack, 1); // to Mid Diff
